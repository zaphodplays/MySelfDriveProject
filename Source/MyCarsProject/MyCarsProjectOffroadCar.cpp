...
AMyCarsProjectOffroadCar::AMyCarsProjectOffroadCar(const FObjectInitializer& ObjectInitializer)
	:Super(ObjectInitializer)
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UMyCarsProjectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UMyCarsProjectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UMyCarsProjectOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UMyCarsProjectOffroadWheelRear::StaticClass();
