...
AMyCarsProjectSportsCar::AMyCarsProjectSportsCar(const FObjectInitializer& ObjectInitializer)
	:Super(ObjectInitializer)
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UMyCarsProjectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UMyCarsProjectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UMyCarsProjectSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UMyCarsProjectSportsWheelRear::StaticClass();
