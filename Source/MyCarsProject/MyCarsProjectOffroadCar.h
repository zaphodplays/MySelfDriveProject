...
#include "MyCarsProjectOffroadCar.generated.h"

/**
 *  Offroad car wheeled vehicle implementation
 */
UCLASS(abstract)
class MYCARSPROJECT_API AMyCarsProjectOffroadCar : public AMyCarsProjectPawn
{
	GENERATED_BODY()
...
public:
	...
	AMyCarsProjectOffroadCar(const FObjectInitializer& ObjectInitializer);
};
