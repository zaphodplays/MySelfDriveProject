...
#include "MyCarsProjectPawn.generated.h"
 ...
 */
UCLASS(abstract)
class AMyCarsProjectPawn : public AWheeledVehiclePawn
{
	GENERATED_BODY()
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Camera, meta = (AllowPrivateAccess = "true"))
	TObjectPtr<class UMySportsCarMovementComponent> SportsCarMovement;
...
public:
	...
	AMyCarsProjectPawn(const FObjectInitializer& ObjectInitializer);
...
public:
	...
	FORCEINLINE const TObjectPtr<class UMySportsCarMovementComponent>& GetChaosVehicleMovement() const { return SportsCarMovement; }
};
